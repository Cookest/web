...
export default function Showcase() {
  ...
  const phones = [
    ...
    {
      src: "/phones/screen-4.svg",
      alt: "Groceries list screen",
      rotate: 8,
      x: 60,
      delay: 0.3,
      size: mobile ? 140 : 210,
  ...
  return (
    <section
      ...
      style={{
        ...
        background: "linear-gradient(180deg, var(--bg) 0%, rgba(180,204,158,0.12) 50%, var(--bg) 100%)",
      }}
    >
      <div className="mx-auto max-w-6xl px-6">
        ...
        >
          ...
          <p
            style={{ fontSize: "1rem", color: "var(--text-muted)", lineHeight: 1.75, maxWidth: 480, margin: "0 auto" }}
          >
            {t("showcase.subtitle")}
          </p>
        </motion.div>
          ...
          {phones.map((phone, i) => (
            <motion.div
              ...
              style={{
                filter:
                  i === 1
                    ? "drop-shadow(0 40px 60px rgba(28,58,42,0.28))"
                    : "drop-shadow(0 24px 40px rgba(28,58,42,0.18))",
