        ...
        >
          ...
          <div>
            ...
            >
              ...
              <p style={{ fontSize: "1rem", color: "var(--text-muted)", lineHeight: 1.78, marginBottom: 32 }}>
                {t("sustain.subtitle")}
              </p>
            </motion.div>
              ...
              {sdgs.map((sdg, i) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: "0.88rem", fontWeight: 600, color: "var(--heading)" }}>
                      {t(sdg.labelKey)}
                    </div>
                  </div>
                </motion.div>
