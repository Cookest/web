...
const features: { Icon: LucideIcon; titleKey: TranslationKey; descKey: TranslationKey; color: string }[] = [
  { Icon: Archive, titleKey: "features.inventory.title", descKey: "features.inventory.desc", color: "var(--primary)" },
  { Icon: Sparkles, titleKey: "features.planner.title", descKey: "features.planner.desc", color: "var(--primary-dark)" },
  { Icon: ChefHat, titleKey: "features.recipes.title", descKey: "features.recipes.desc", color: "var(--primary)" },
  { Icon: ShoppingCart, titleKey: "features.grocery.title", descKey: "features.grocery.desc", color: "var(--primary-dark)" },
];
    ...
    >
      <div
        style={{
          ...
          height: 52,
          borderRadius: 14,
          background: f.color === "var(--primary)" ? "rgba(122,154,101,0.12)" : "rgba(78,122,58,0.12)",
          display: "flex",
          alignItems: "center",
