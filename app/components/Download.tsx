...
export default function Download() {
  ...
  return (
    <section id="download" style={{ padding: "100px 0", background: "var(--heading)", position: "relative", overflow: "hidden" }}>
      ...
      <style>{`.download-ghost-btn { border-color: rgba(180,204,158,0.3) !important; color: rgba(255,255,255,0.85) !important; }`}</style>
    </section>
  );
}
