    ...
    >
      ...
      <div
        style={{
          ...
          height: 400,
          borderRadius: "50%",
          background: "rgba(78,122,58,0.15)",
          filter: "blur(50px)",
          pointerEvents: "none",
        }}
      />
        ...
        >
          <span
            style={{
              ...
              background: "rgba(180,204,158,0.15)",
              ...
              borderRadius: 100,
              marginBottom: 24,
              border: "1px solid rgba(180,204,158,0.2)",
            }}
          >
            {t("download.label")}
          </span>
          ...
          >
            {t("download.title1")}
            <br />
            <em style={{ color: "var(--primary-light)", fontStyle: "italic" }}>{t("download.title2")}</em>
          </h2>
          <p
            style={{
              fontSize: "1rem",
          ...
          <p style={{ marginTop: 32, fontSize: "0.78rem", color: "rgba(255,255,255,0.35)" }}>
